 ...
 *   Production: npx tsx scripts/check-console-errors.ts https://prakhar-ai.dev
 *
...
function getUrls(): string[] {
  ...
  urls.push('https://prakhar-ai.dev/privacy', 'https://prakhar-ai.dev/about')

  // Convert to use the base URL
  return urls.map(url => url.replace('https://prakhar-ai.dev', baseUrl))
}
