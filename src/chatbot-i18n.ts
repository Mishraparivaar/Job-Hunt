export const chatbotContent = {
    es: {
      ...
      seo: {
        title: 'El Chatbot Que Se Cura Solo: De Widget a LLMOps en Producción | prakhar-ai.dev',
      ...
      header: {
        kicker: 'Case Study — prakhar-ai.dev (lo estás usando ahora mismo)',
  ...
  for await (const event of response) {
    res.write(\`data: \${JSON.stringify(event)}\\n\\n\`)
        ...
        defense: {
          ...
          linkedInPostUrl: 'https://www.linkedin.com/in/prakhar-mishra-b74b85124-mishra-b74b85124/',
        ...
        evals: {
          ...
          table: {
            ...
            rows: [
              ['Factual', '"¿Dónde estudió Prakhar?"', 'contains("IE Business School")'],
              ['Persona', '"¿Cómo te llamas?"', 'contains("Prakhar")'],
...
Producción
  ...
  └──────────────── CI evals ←────────────────┘
      ...
      faq: {
        ...
        items: [
          ...
          },
          {
            ...
            a: 'Sí. El código es público en GitHub (github.com/Mishraparivaar/Job-Hunt). El patrón (chat + Langfuse + evals + CI) es replicable en un fin de semana. Lo que lleva tiempo es el closed-loop y el RAG agéntico, pero puedes empezar sin ellos e iterar.',
          },
          {
    ...
    en: {
      ...
      seo: {
        title: 'The Self-Healing Chatbot: From Widget to Production LLMOps | prakhar-ai.dev',
      ...
      header: {
        kicker: 'Case Study — prakhar-ai.dev (you\'re using it right now)',
...
export default async function handler(req, res) {
  ...
  const response = await anthropic.messages.create({
    model: 'claude-sonnet-4-5-20250929',
    max_tokens: 500,
    system: 'You are Prakhar, an AI PM...',
    messages,
    stream: true,
  })
  // Stream SSE to client
    ...
    res.write(\`data: \${JSON.stringify(event)}\\n\\n\`)
        ...
        evals: {
          ...
          table: {
            ...
            rows: [
              ['Factual', '"Where did Prakhar study?"', 'contains("IE Business School")'],
              ['Persona', '"What\'s your name?"', 'contains("Prakhar")'],
      ...
      faq: {
        ...
        items: [
          ...
          },
          {
            ...
            a: 'Yes. The code is public on GitHub (github.com/Mishraparivaar/Job-Hunt). The pattern (chat + Langfuse + evals + CI) is replicable in a weekend. What takes time is the closed-loop and agentic RAG, but you can start without them and iterate.',
          },
          {
