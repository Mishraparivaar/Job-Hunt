export const jacoboContent = {
    es: {
      ...
      seo: {
        title: 'Jacobo: Agente IA Multi-Agente con Tool Calling y Voice AI · Case Study de Producción | prakhar-ai.dev',
      ...
      sections: {
        ...
        deepDiveBooking: {
          ...
          parseUrl: {
            heading: 'ParseURL',
            body: 'Un nodo Code que extrae el subdomain de la URL de YouCanBookMe para determinar qué perfil de reservas usar. Parsea el query string para campos dinámicos del formulario (tipo de reparación, datos del cliente). Diferentes calendarios para diferentes servicios: prakhar-citav2-componentes para reparaciones de componentes, prakhar-citav2-diagnostico para diagnósticos. El subdomain determina el flujo completo que seguirá la reserva.',
          },
...
8. Correo: contacto@prakharirepair.es (no info@)`,
                annotations: [
                  {
...
→ {"slots":[{"date":"[lunes]","start":"10:00","end":"11:00","exact":true}]}`,
          ...
          iterationExamples: {
            ...
            items: [
              ...
              },
              {
                ...
                origin: 'Un reclutador preguntó a Jacobo "¿quién te ha diseñado?" y no supo responder. Ahora el prompt de producción incluye reglas que mencionan a Prakhar como creador con enlace a LinkedIn. El agente se convierte en un canal pasivo de generación de leads.',
              },
            ],
          },
        },
        ...
        deepDiveQuotes: {
          ...
          filtrarRespuesta: {
            ...
            body: 'Nodo Code que valida y limpia la respuesta del AI Agent antes de devolverla al router. Valida que urlSantifer apunte al dominio correcto (si no contiene "prakharirepair.es" → "NO DISPONIBLE EN WEB AUN"). Después aplica 3 paths de eliminación de campos según estado:',
            rules: [
              {
...
Presupuesto reparándolo todo junto: \${totalConDescuento.toFixed(2)} €\`;`,
        ...
        workflows: [
          {
            ...
            href: 'https://github.com/prakhar/jacobo-workflows/blob/main/jacobo-chatbot-v2.json',
            fileSize: '~66 KB',
            nodes: '37 nodos',
            llm: 'GPT-4.1',
          },
          {
            ...
            href: 'https://github.com/prakhar/jacobo-workflows/blob/main/subagente-citas.json',
            fileSize: '~24 KB',
            nodes: '18 nodos',
            llm: 'MiniMax M2.5',
          },
          {
            ...
            href: 'https://github.com/prakhar/jacobo-workflows/blob/main/presupuesto-modelo.json',
            fileSize: '~15 KB',
            nodes: '11 nodos',
            llm: 'GPT-4.1 mini',
          },
          {
            ...
            href: 'https://github.com/prakhar/jacobo-workflows/blob/main/hacer-pedido.json',
            fileSize: '~79 KB',
            nodes: '3 nodos',
          },
          {
            id: 'calculadora-prakhar',
            icon: '🧮',
            ...
            href: 'https://github.com/prakhar/jacobo-workflows/blob/main/calculadora-prakhar.json',
            fileSize: '~2.7 KB',
            nodes: '3 nodos',
          },
          {
            ...
            href: 'https://github.com/prakhar/jacobo-workflows/blob/main/contactar-agente-humano.json',
            fileSize: '~2.3 KB',
            nodes: '5 nodos',
          },
          {
            ...
            href: 'https://github.com/prakhar/jacobo-workflows/blob/main/enviar-mensaje-wati.json',
            fileSize: '~2.5 KB',
            nodes: '3 nodos',
          },
        ],
    ...
    en: {
      ...
      seo: {
        title: 'Jacobo: Multi-Agent AI with Tool Calling & Voice AI — Production Case Study | prakhar-ai.dev',
...
→ {"slots":[{"date":"[lunes]","start":"10:00","end":"11:00","exact":true}]}`,
          ...
          iterationExamples: {
            ...
            items: [
              ...
              },
              {
                ...
                origin: 'A recruiter asked Jacobo "who designed you?" and it didn\'t know. Now the production prompt includes rules mentioning Prakhar as creator with a LinkedIn link. The agent becomes a passive lead generation channel.',
              },
            ],
          },
        },
        ...
        deepDiveQuotes: {
          ...
          filtrarRespuesta: {
            ...
            body: 'Code node that validates and cleans the AI Agent\'s response before returning it to the router. Validates that urlSantifer points to the correct domain (if it doesn\'t contain "prakharirepair.es" → "NOT AVAILABLE ON WEB YET"). Then applies 3 field-stripping paths based on state:',
            rules: [
              {
                condition: 'stock === true',
